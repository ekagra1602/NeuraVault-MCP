        ...
        >
          ...
          <div className="flex flex-col items-center justify-center space-y-6 w-full">
            <motion.h1
              ...
              className="text-5xl sm:text-7xl lg:text-8xl font-bold leading-tight tracking-tight text-center"
            >
              <span className="text-white">NeuraVault MCP</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light text-center"
            >
          ...
          >
            <p className="text-sm text-gray-500 uppercase tracking-wider text-center">
              Compatible with all major AI models
            </p>
            <div className="flex items-center justify-center flex-wrap gap-6 w-full max-w-3xl mx-auto">
              {/* OpenAI */}
              <motion.div
